...
return require('packer').startup(function()
  ...
  use {
    'dense-analysis/ale',
    ft = {
      'sh', 'zsh', 'bash', 'c', 'cpp', 'cmake', 'html', 'markdown', 'racket',
      'vim', 'tex', 'yaml', 'dockerfile', 'terraform', 'lua', 'go'
    },
    cmd = 'ALEEnable',
  ...
  use {'ojroques/nvim-lspfuzzy', run = function() require('lspfuzzy').setup() end}
  ...
  use {'tjdevries/colorbuddy.vim', {'nvim-treesitter/nvim-treesitter', config = conf('nvim-treesitter'), run = ':TSUpdate'}}
